...
if __name__ == '__main__':
    ...
    with col12:
        st.markdown('https://link.springer.com/chapter/10.1007/978-981-16-1642-6_30')
    st.divider()
    ...
    with col11:
        st.markdown(':orange[Available at: ]')
    with col12:
        st.markdown('https://link.springer.com/chapter/10.1007/978-981-16-1642-6_11')
    st.divider()
    ...
    with col11:
        st.markdown(':orange[Available at: ]')
    with col12:
        st.markdown('https://link.springer.com/chapter/10.1007/978-981-16-1642-6_14')
    st.divider()
    ...
    with col11:
        st.markdown(':orange[Available at: ]')
    with col12:
        st.markdown('https://ieeexplore.ieee.org/document/8978331')
    st.divider()
    ...
    with col11:
        st.markdown(':orange[Available at: ]')
    with col12:
        st.markdown('https://www.ijrte.org/wp-content/uploads/papers/v8i3/C5139098319.pdf')
    st.divider()
    ...
    with col11:
        st.markdown(':orange[Available at: ]')
    with col12:
        st.markdown('https://ijamtes.org/VOL-9-ISSUE-03-2019-1/')
    st.divider()
