...
if __name__ == "__main__":
    ...
    with col5:
        st.markdown('<div style="text-align: justify">Hey! This is Gururaj. Currently, I am working as an Associate Data Scientist at Emplay Inc, where I bring together my expertise in Generative AI (GenAI) and traditional Machine Learning (ML) to deliver impactful solutions across multiple domains. I focus on creating advanced, intelligent chatbots and cutting-edge tools that redefine human-technology interaction. I’m involved throughout the data science lifecycle—from data extraction and transformation to modeling and implementation. This role allows me to work on a range of projects, addressing complex regression and classification challenges that drive business insights and process efficiencies. </div>', unsafe_allow_html=True)
        st.write('')
    ...
    st.write('')
    st.markdown('<div style="text-align: justify"> While working as Consultant at CapGemini consulting India Pvt. Ltd. for Alcatel-Lucent client based out of US my diligence at work was recognized and awarded. This role provided valuable experience working in a high-paced environment and collaborating with global teams, skills that have greatly benefited my journey in IT industry. <div>', unsafe_allow_html=True)
    st.write('')
    st.markdown('<div style="text-align: justify"> Throughout my academic journey, I have consistently excelled, with achievements such as having my undergraduate project funded by prestigious IISC,Bengaluru and receiving runner-up recognition at a Seminar held by The National Academy of Sciences for the abstract of my master’s dissertation on renewable energy. My passion for research has led me to author six technical papers published in reputed journals like Springer and IEEE, where I have also reviewed manuscripts.  <div>', unsafe_allow_html=True)
    st.write('')
    st.markdown('<div style="text-align: justify"> Beyond data and technology, I am passionate about driving and spending time by the beach, both of which bring a sense of calm to my life. I love traveling, learning about new cultures, meeting new people, and exploring different languages. Watching sci-fi movies is one of my favorite pastimes, and my favorite superhero is Ironman—a character who mirrors my own drive to innovate and excel. I am a highly motivated and diligent individual, always seeking new opportunities to learn, grow and excel. <div>', unsafe_allow_html=True)
